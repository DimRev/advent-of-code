...
# Day 9
python-d9p1:
	$(call print_py_title,Day 9 Part 1)
	@cd 2025/python && python main.py d9p1

python-d9p2:
	$(call print_py_title,Day 9 Part 2)
	@cd 2025/python && python main.py d9p2

# All Days
python-all: python-d1p1 python-d1p2 python-d2p1 python-d2p2 python-d3p1 python-d3p2 python-d4p1 python-d4p2 python-d5p1 python-d5p2 python-d6p1 python-d6p2 python-d7p1 python-d7p2 python-d8p1 python-d8p2 python-d9p1 python-d9p2
...
# Day 9
go-d9p1:
	$(call print_go_title,Day 9 Part 1)
	@cd 2025/go && go run main.go d9p1

go-d9p2:
	$(call print_go_title,Day 9 Part 2)
	@cd 2025/go && go run main.go d9p2

# All Days
go-all: go-d1p1 go-d1p2 go-d2p1 go-d2p2 go-d3p1 go-d3p2 go-d4p1 go-d4p2 go-d5p1 go-d5p2 go-d6p1 go-d6p2 go-d7p1 go-d7p2 go-d8p1 go-d8p2 go-d9p1 go-d9p2
...
# Day 9
ts-d9p1:
	$(call print_ts_title,Day 9 Part 1)
	@cd 2025/ts && pnpm start d9p1

ts-d9p2:
	$(call print_ts_title,Day 9 Part 2)
	@cd 2025/ts && pnpm start d9p2

# All Days
ts-all: ts-d1p1 ts-d1p2 ts-d2p1 ts-d2p2 ts-d3p1 ts-d3p2 ts-d4p1 ts-d4p2 ts-d5p1 ts-d5p2 ts-d6p1 ts-d6p2 ts-d7p1 ts-d7p2 ts-d8p1 ts-d8p2 ts-d9p1 ts-d9p2
...
# Day 9
all-d9p1: render-init go-d9p1 python-d9p1 ts-d9p1 render-render
all-d9p2: render-init go-d9p2 python-d9p2 ts-d9p2 render-render
all-d9: render-init go-d9p1 go-d9p2 python-d9p1 python-d9p2 ts-d9p1 ts-d9p2 render-render
